...
### AI 에이전트 & 개발 도구
- [awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) (15K+ stars)
...
### 디렉토리
- [mcp.so](https://mcp.so) - 3,000+ 서버 인덱스
- [mcp-awesome.com](https://mcp-awesome.com) - 1,200+ 검증된 서버
- [Docker MCP Toolkit](https://www.docker.com/blog/add-mcp-servers-to-claude-code-with-mcp-toolkit/) - 220+ 서버

### 공식 서버
- [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) - Anthropic 공식

---

## 플러그인 & 스킬 마켓

- [claude-plugins.dev](https://claude-plugins.dev) - 11,989개 플러그인
...
- [claude-hooks](https://github.com/johnlindquist/claude-hooks) - TypeScript 기반
